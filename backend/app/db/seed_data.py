...
def seed_database():
    ...
    # 4. Workers
    workers = [
        Worker(worker_id="EMP-8472", name="Ramesh Kumar", role="Signal Technician", zone="Track A - Sector 4", activity="Signal Calibration", compliance_status="NORMAL", helmet_ok=True, vest_ok=True, boots_ok=True, eye_protection_ok=True, timestamp=now),
        Worker(worker_id="EMP-9102", name="Suresh Singh", role="Track Maintenance Lead", zone="Platform 3 - North", activity="Bolting & Inspection", compliance_status="VIOLATION", helmet_ok=False, vest_ok=True, boots_ok=True, eye_protection_ok=False, timestamp=now),
        Worker(worker_id="EMP-3341", name="Amit Patel", role="Electrical Tech", zone="Depot Yard B", activity="Rest & Break", compliance_status="BREAK", helmet_ok=True, vest_ok=True, boots_ok=True, eye_protection_ok=True, timestamp=now),
        Worker(worker_id="EMP-5529", name="Vikram Sharma", role="Track Worker", zone="Track A - Sector 5", activity="Rail Welding", compliance_status="NORMAL", helmet_ok=True, vest_ok=True, boots_ok=True, eye_protection_ok=True, timestamp=now),
        Worker(worker_id="EMP-4902", name="J. Miller", role="Senior Signal Tech", zone="Sector 3 Alpha", activity="Switch Gear Check", compliance_status="NORMAL", helmet_ok=True, vest_ok=True, boots_ok=True, eye_protection_ok=True, timestamp=now)
    ]
    for w in workers:
        db.add(w)
