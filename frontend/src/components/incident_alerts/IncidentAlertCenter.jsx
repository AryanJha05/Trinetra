  ...
  const incidents = [
    {
      ...
      cam: 'CAM-NDLS-042',
      zone: 'Platform 4, Sector B (Near Pillar 12)',
      time: '10:42 AM (8 mins ago)',
      severity: 'CRITICAL',
      conf: '96.0%',
      status: 'Security Team Notified',
      assigned: 'RPF Unit 4',
      recommended_action: 'Dispatch immediate bomb disposal & cordon Platform 4 North.',
    ...
    },
    {
      ...
      cam: 'CAM-NDLS-004',
      zone: 'Maintenance Yard B (Gate 4 Perimeter)',
    ...
    {
      id: 'INC-2026-875',
      title: 'Staff PPE Helmet Violation',
      cam: 'CAM-NDLS-001',
      zone: 'Platform 1 - Sector A Track Edge',
